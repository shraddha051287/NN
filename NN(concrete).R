...
l_resset.seed(12323)
modeults <- compute(concrete_model,concrete_test[1:8])
str(model_results)
...
model_5<-neuralnet(strength~cement+slag+ash+water+superplastic+coarseagg+fineagg+age,data= concrete_train,hidden=2)
plot(model_5)
